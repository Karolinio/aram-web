...
/**
 * ═══ Die Lage ist ein Raster, kein Wurf ═══
 *
 * Karol am 12.09.: „nicht ueberlappend, sondern wild nebeneinander, aber
 * immer Platz voneinander lassen, und so platzieren, dass man sie im
 * Hintergrund erkennen kann."
 *
 * Vorher waren die Werte ein Wurf — und nachdem am 11.09. alle Groessen um
 * 18 % gewachsen sind, lagen neun Stuecke von bis zu 38 % Breite auf einer
 * Flaeche, die das nicht hergibt. Sie ueberschnitten sich, und ueberschnitten
 * verdecken sie einander statt aufzufallen.
 *
 * Jetzt drei Spalten (li 2 / 36 / 70) und drei Zeilen (ob 3 / 38 / 73), jedes
 * Stueck hoechstens 30 % breit. Rechte Kante ≤ 98, senkrechte Luft ≥ 12 %.
 * „Wild" kommt aus dem Wechsel der Groessen und Drehungen, nicht aus dem
 * Uebereinander. Die kleinen Wiederholungen (`-fern`) sitzen in den Luecken.
 * Am Handy zwei Spalten (liM 2 / 50), dort ist das Raster 2 x 5.
 */
export const GEBAECKE: Gebaeck[] = [
  {
    ...
    echt: true,
    alt: 'Ein Käseschiff von Aram: ein geschlossenes Schiffchen aus Teig, mit Sesam und Schwarzkümmel bestreut, in der Mitte tritt der Käse aus der Naht',
    li: 68,
    ob: 72,
    gr: 28,
    tiefe: 0.5,
  ...
  },
  {
    id: 'rolle',
    dampft: true,
    name: 'Grosses Kaeseschiff',
    bilder: ['/bilder/echt/schwarm-rolle.webp'],
    echt: true,
    alt: 'Ein langes Käseschiff von Aram, goldbraun gebacken, mit Sesam und Schwarzkümmel, die Naht in der Mitte weit geöffnet',
    li: 70,
    ob: 40,
    gr: 26,
    tiefe: 0.62,
  ...
  },
  {
    ...
    echt: true,
    alt: 'Ein Lahmacun von Aram, dünn ausgerollt und flächig mit Hackfleisch belegt',
    li: 2,
    ob: 3,
    gr: 30,
    tiefe: 0.0,
  ...
  },
  {
    ...
    echt: true,
    alt: 'Ein Zaatar von Aram: ein runder Fladen, dunkel mit Zaatar bestrichen und dicht mit Sesam bestreut',
    li: 70,
    ob: 2,
    gr: 28,
    tiefe: 0.25,
  ...
  },
  {
    id: 'zaatar-2',
    dampft: true,
    name: 'Fladen mit Oliven',
    bilder: ['/bilder/echt/schwarm-zaatar-2.webp'],
    echt: true,
    alt: 'Ein Fladen von Aram mit grünen Oliven, gewürfelten Tomaten und Scheiben Hirtenkäse',
    li: 2,
    ob: 74,
    gr: 28,
    tiefe: 0.12,
  ...
  },
  {
    ...
    echt: true,
    alt: 'Ein rundes Sesambrot von Aram, dicht mit Sesam und Schwarzkümmel bestreut',
    li: 40,
    ob: 5,
    gr: 20,
    tiefe: 1.0,
  ...
  },
  {
    id: 'gebacken',
    dampft: true,
    name: 'Fladen mit Kartoffeln',
    bilder: ['/bilder/echt/schwarm-gebacken.webp'],
    echt: true,
    alt: 'Ein Fladen von Aram mit gewürfelten Kartoffeln, Paprika und einer Tomatenscheibe',
    li: 2,
    ob: 39,
    gr: 22,
    tiefe: 0.88,
  ...
  },
  {
    id: 'kaese',
    dampft: true,
    name: 'Kaeseschiff scharf',
    bilder: ['/bilder/echt/schwarm-kaese.webp'],
    echt: true,
    alt: 'Ein scharfes Käseschiff von Aram, schmal und geschlossen, mit Sesam und Schwarzkümmel bestreut',
    li: 38,
    ob: 75,
    gr: 24,
    tiefe: 0.75,
  ...
  },
  {
    id: 'stapel',
    dampft: true,
    name: 'Fladen mit Hack und Kaese',
    bilder: ['/bilder/echt/schwarm-stapel.webp'],
    echt: true,
    alt: 'Ein Fladen von Aram mit Hackfleisch und vier Würfeln Hirtenkäse',
    li: 34,
    ob: 37,
    gr: 28,
    tiefe: 0.38,
